...
function attachToCenter(particle) {
...
class Particle {
    constructor(color = '#000', x = 0, y = 0, friction = 1) {
    ...
    update() {
        ...
        this.el.style.transform = `translate(${this.position.x - this.sizeHalf}px,
            ${this.position.y - this.sizeHalf}px)`;
    }
}
